...
if active_tab == "Segnale Attuale":
    ...
    stop_loss_perc_backtest = st.sidebar.slider("Stop Loss sulle Coperture (%)", 0, 50, 6, help="Impostare a 0 per disattivare lo stop loss.") / 100.0    run_backtest_button = st.sidebar.button("Esegui Backtest", type="primary")
